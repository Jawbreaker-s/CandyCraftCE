...
import cn.jawbreakers.candycraftce.registry.worldgen.CFoliagePlacers.candied_cherry
...
class CandiedCherryFoliagePlacer : FoliagePlacer(ConstantInt.of(2), ConstantInt.of(1)) {
    ...
    override fun foliageHeight(random: RandomSource, height: Int, config: TreeConfiguration): Int = height - 1
